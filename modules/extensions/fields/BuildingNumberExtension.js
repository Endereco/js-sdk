...
const BuildingNumberExtension = {
    ...
    registerFields: (ExtendableObject) => {
        ...
        Object.defineProperty(ExtendableObject, 'buildingNumber', {
            ...
            set: async (value) => {
                const needToNotify = ExtendableObject.active && ExtendableObject._allowToNotifyBuildingNumberSubscribers;
                ...
                try {
                    ...
                    if (needToNotify) {
                        ...
                        ExtendableObject._subscribers.buildingNumber.forEach((subscriber) => {
                            subscriber.value = buildingNumber;
                        });
                    }
    ...
    registerFilterCallbacks: (ExtendableObject) => {
        ExtendableObject.cb.setBuildingNumber = async (buildingNumber) => {
